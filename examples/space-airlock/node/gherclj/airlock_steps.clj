(ns gherclj.airlock-steps
  "Step routing for the JavaScript implementation of SpaceAirlock.
   Each entry maps a Gherkin phrase to a method call on airlock or checks."
  (:require [gherclj.core :refer [defgiven defwhen defthen helper!]]
            [gherclj.frameworks.javascript.node-test :as js]))

(helper! "src/space_airlock.js")
