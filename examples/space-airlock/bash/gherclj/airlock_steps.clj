(ns gherclj.airlock-steps
  "Step routing for the Bash implementation of SpaceAirlock.
   Each entry maps a Gherkin phrase to a shell function call on airlock or checks."
  (:require [gherclj.core :refer [defgiven defwhen defthen helper!]]
            [gherclj.frameworks.bash.testing :as bash]))

(helper! "lib/space_airlock.sh")
(helper! "lib/airlock_checks.sh")
