...
(def ^:private cli-options
  [["-f" "--features-dir DIR" "Features directory"]
   ...
   ["-t" "--tag TAG" "Generate only the scenarios with the specified tag(s). To exclude, prefix the tag with ~ (eg ~slow). Use this option multiple times to filter multiple tags. (default: ~wip)"
    :multi true
    :default :none
    :default-desc ""
